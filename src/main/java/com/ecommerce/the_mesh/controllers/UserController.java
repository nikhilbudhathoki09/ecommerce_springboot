...
public String handleSignupForm(@Valid @ModelAttribute User user, BindingResult result, @RequestParam("user_image") MultipartFile file, Model model) throws IOException{
